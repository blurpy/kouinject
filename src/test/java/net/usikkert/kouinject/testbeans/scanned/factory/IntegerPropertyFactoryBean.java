...
/**
 * Test of having an alternative factory with Any, in addition to the string factory.
 *
 * @author Christian Ihle
 */
@Component
public class IntegerPropertyFactoryBean {

    private static final String PROPERTY_FILE = "FactoryTestProperties.properties";

    private final Properties properties;

    public IntegerPropertyFactoryBean() {
        properties = new Properties();
        loadPropertyFile();
    }

    @Produces @Any
    public Integer createIntegerProperty(final FactoryContext factoryContext) {
